...
function draw() 
{
    ...
    fill("#E23C12");
    noStroke();
    ellipse(20*width/100, 25*height/100,diameter,diameter);

    fill("#D10B5B");  //#BD320F
    noStroke();
    ellipse(50*width/100, 25*height/100,diameter,diameter);
    ...
    */
    ...
    fill("#189CD8");      //#97280C
    noStroke();
    ellipse(20*width/100, 55*height/100,diameter,diameter);

    fill("#BD320F");
    noStroke();
    ellipse(50*width/100, 55*height/100,diameter,diameter);
    ...
    */
    ...
    fill("#DE2697");  // #97280C
    noStroke();
    ellipse(20*width/100, 85*height/100,diameter,diameter);
