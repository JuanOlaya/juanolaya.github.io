...
const a1Groups = indexDíata.groups.filter(group => group.level === 'A1.1' || group.level === 'A1.2');
...
function buildHtml() {
    const pages = chunk(a1Groups, groupsPerPage);
...
function writePdf() {
    ...
    const headlessProfileDir = path.join(outputDir, '.edge-headless-profile-a1');
