...
// 4. Move Forschung from B1.1 to B2.1
const forschungGroup = data.groups.find(g => g.groupNameGerman === 'Forschung' && g.level === 'B1.1');
if (forschungGroup) {
    forschungGroup.level = 'B2.1';
    // Remove it from current array position and append to the end of B2.1 block visually
...
// 5. Reorder Hygiene and Ordnung (both A1.2) to be sequential
