...
function buildHtml() {
    const pages = chunk(a2Groups, groupsPerPage);
...
<head>
    ...
    <title>Kompakt A2 Portrait With IK LiD Refl</title>
    <style>
        @page {
...
function writePdf() {
    ...
    const headlessProfileDir = path.join(outputDir, `edge-headless-profile-a2-${Date.now()}`);
