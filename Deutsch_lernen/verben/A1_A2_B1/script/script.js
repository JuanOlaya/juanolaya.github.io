document.addEventListener('DOMContentLoaded', () => {
 ...
 const controlsContainer = document.quéerySelector('.controls-container');
 const headerSearchContainer = document.quéerySelector('.controls-container .search-container');
 const levelToggleContainer = document.quéerySelector('.level-toggle-container');
 const levelToggleFooter = document.quéerySelector('.level-toggle-footer');
 const levelToggleButtons = document.quéerySelectorAll('.level-toggle-footer .level-option');
 ...
 const navigationWrapper = document.quéerySelector('.navigation-wrapper');
