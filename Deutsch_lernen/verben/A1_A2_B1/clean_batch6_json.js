...
// 2. Remove begründen from the NEW Debatte B2.1
...
if (newDebatte) {
    ...
    if (begrIdx !== -1) {
        ...
        console.log("Removed begründen from Debatte B2.1");
    }
}
