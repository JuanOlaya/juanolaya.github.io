...
const printHtml = [
    ...
    '    .print-page { width: 210mm; height: 297mm; padding: 4mm 5mm; display: flex; flex-direction: column; break-after: page; page-break-after: always; overflow: hidden; }',
    '    .print-page:last-child { break-after: auto; page-break-after: auto; }',
    '    .page-header { height: 12mm; flex: 0 0 12mm; display: flex; justify-content: space-between; align-items: center; gap: 4mm; border-bottom: 0.6mm solid #0f172a; margin-bottom: 2mm; padding: 0 1mm 1.5mm; }',
    '    .page-kicker { color: #475569; font-size: 6.5pt; font-weight: 800; letter-spacing: 0.8pt; }',
    '    .page-header h1 { margin: 0.5mm 0 0; font-family: "Outfit", "Segoe UI", sans-serif; font-size: 13pt; line-height: 1; }',
    '    .page-note { max-width: 70mm; color: #64748b; font-size: 7pt; font-weight: 600; text-align: right; }',
    '    .grid { flex: 1; min-height: 0; display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); grid-template-rows: repeat(2, minmax(0, 1fr)); gap: 2.5mm; }',
    ...
    '    .kompakt-header { min-height: 9.5mm; flex: 0 0 9.5mm; display: flex; align-items: center; justify-content: space-between; gap: 3mm; padding: 1.8mm 3mm; color: #fff; }',
    '    .header-de { flex-shrink: 0; font-family: "Outfit", "Segoe UI", sans-serif; font-size: 11pt; font-weight: 800; text-transform: uppercase; }',
    '    .header-es { min-width: 0; overflow: hidden; font-size: 9pt; font-style: italic; font-weight: 700; text-align: right; text-overflow: ellipsis; white-space: nowrap; }',
    ...
    '    .kompakt-spanish { color: #0f172a; font-size: 10.5pt; font-style: italic; font-weight: 700; }',
    '    .level-badge { flex-shrink: 0; padding: 0.2mm 1.2mm; border: 0.25mm solid #cbd5e1; border-radius: 1.2mm; background: #f1f5f9; color: #334155; font-size: 6.5pt; font-weight: 800; }',
    '    .kompakt-example { margin-top: 0.4mm; overflow: hidden; color: #334155; font-size: 6.8pt; line-height: 1.15; }',
    '    .kompakt-example-de strong { color: #0f172a; font-weight: 800; }',
    '    .kompakt-example-de .german-word { color: #0f172a; font-weight: 800; text-decoration: underline; }',
    '    .kompakt-example-es { color: #475569; font-style: italic; font-size: 6.2pt; margin-top: 0.15mm; }',
    '    .kompakt-section { flex: 0 0 auto; padding: 0.8mm 2.4mm; font-size: 6.5pt; font-weight: 800; letter-spacing: 0.55pt; text-align: center; text-transform: uppercase; }',
    ...
    '    .kompakt-footer { min-height: 8.5mm; flex: 0 0 8.5mm; display: flex; align-items: center; justify-content: center; padding: 1.2mm 2mm; color: #fff; font-size: 9pt; font-weight: 800; letter-spacing: 0.05pt; text-align: center; white-space: nowrap; }',
    '    .without-examples .kompakt-german { font-size: 17pt; }',
    '    .without-examples .kompakt-spanish { font-size: 11.5pt; }',
    '  </style>',
    '</head>',
    '<body>',
