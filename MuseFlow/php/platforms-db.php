...
foreach ($data as $item) {
    $query .= "INSERT INTO PlatformsPhase2 (CaseNumber, PlatformID, TotalVisitsPlatformGame, LastVisitTimeSpentOnPlat, TotalTimeSpentOnPlat, LastStrokesLeftArrow, LastStrokesRightArrow, TotalStrokesLeftArrowOnPlat, TotalStrokesRightArrowOnPlat, LastVisitMissedOpporOnPlat, TotalMissedOpportOnPlat, ReactionTimeSinceUnobstructed, TimeSpentSinceUnobstructed, TotalMissedOpportGame ) VALUES ('"
    .$item["CaseNumber"]."', '"
    .$item["PlatformID"]."', '"
    ...
    .$item["ReactionTimeSinceUnobstructed"]."', '"
    .$item["TimeSpentSinceUnobstructed"]."', '"
